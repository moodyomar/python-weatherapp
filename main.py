...
def get_test_page():
        return "<h1>This is just a test page</h1><br><p>Feel free to go back</p></div><div class='bg-overlay'>"
    
@app.route('/map', methods=['GET'])
def get_map_page():
        return "<h1>Someday maybe I'll add a map here</h1><br><p>Feel free to go back</p></div><div class='bg-overlay'>"
